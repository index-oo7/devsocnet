...
CREATE DEFINER=`root`@`localhost` PROCEDURE `searchtopic` (IN `p_topic` VARCHAR(50))   BEGIN
    SELECT * FROM post
    WHERE category LIKE CONCAT('%', p_topic, '%') ;
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `searchuser` (IN `u_name` VARCHAR(50))   BEGIN
    SELECT * FROM app_user
    WHERE user_name LIKE CONCAT('%', u_name, '%') OR user_surname LIKE CONCAT('%', u_name, '%');
END$$
...
CREATE DEFINER=`root`@`localhost` FUNCTION `fun_num_of_posts` (`userId` INT) RETURNS INT(11)  begin 
declare num_of_posts int;
select count(post_id) into num_of_posts
from post 
where user_id=userId;
return num_of_posts;
END$$
...
(2, 'Luka', 'Radovanovic', '2132', 'index007@gmail.com', 'admin', 'ide gas micooooo');
...
(79, 2, '2023-04-03 23:33:21', 'pripremni zadaci za prijemni ispit na fonu', 'fon priprema', '../../uploads/test_na_rac_2012_tekst_Vesna_grp4.pdf', 'pdf', 1),
(80, 2, '2023-04-03 23:44:34', 'provera', 'post', '', '', 1),
(81, 1, '2023-04-04 00:10:04', 'Test post desc', 'Post Test', '', '', 1),
(82, 1, '2023-04-04 00:35:05', 'sadsa', 'sads', '', '', 1);
...
(83, 2, 3, 'komentar', '2023-04-03 00:05:44'),
(84, 2, 3, 'komentar', '2023-04-03 00:05:45'),
(85, 2, 3, 'komentar', '2023-04-03 00:05:47'),
(86, 2, 3, 'komentar', '2023-04-03 00:05:47'),
(87, 2, 3, 'komentar', '2023-04-03 00:05:49'),
(88, 2, 3, 'komentar', '2023-04-03 00:05:49'),
(89, 2, 3, 'komentar', '2023-04-03 00:05:49'),
(90, 2, 3, 'komentar', '2023-04-03 00:05:51'),
(91, 2, 3, 'komentar', '2023-04-03 00:05:51'),
(92, 2, 3, 'komentar', '2023-04-03 00:05:51'),
(93, 2, 3, 'sda', '2023-04-03 00:05:55'),
(94, 2, 3, 'sda', '2023-04-03 00:05:56'),
(95, 2, 3, 'sda', '2023-04-03 00:05:56'),
(96, 1, 2, 'sads', '2023-04-04 00:35:18'),
(97, 1, 2, 'sads', '2023-04-04 00:35:22'),
(98, 1, 2, 'sadssad', '2023-04-04 00:35:24'),
(99, 1, 2, 'sadssad', '2023-04-04 00:35:24'),
(100, 1, 2, 'sadssad', '2023-04-04 00:35:24'),
(101, 2, 80, 'sadsa', '2023-04-04 01:31:22'),
(102, 2, 80, 'sadsa', '2023-04-04 01:31:22'),
(103, 2, 80, 'sadsa', '2023-04-04 01:31:23'),
(104, 2, 80, 'sadsa', '2023-04-04 01:31:23'),
(105, 2, 80, 'sadsa', '2023-04-04 01:31:24'),
(106, 2, 80, 'sadsa', '2023-04-04 01:31:24'),
(107, 2, 80, 'sadsa', '2023-04-04 01:31:24'),
(108, 2, 80, 'sadsa', '2023-04-04 01:31:24'),
(109, 2, 80, 'sadsa', '2023-04-04 01:31:25'),
(110, 2, 80, 'sadsa', '2023-04-04 01:31:26'),
(111, 2, 80, 'sadsa', '2023-04-04 01:31:26'),
(112, 2, 80, 'sadsa', '2023-04-04 01:31:26'),
(113, 2, 80, 'sadsa', '2023-04-04 01:31:27'),
(114, 2, 80, 'sadsa', '2023-04-04 01:31:27'),
(115, 2, 4, 'sdas', '2023-04-04 01:31:32'),
(116, 2, 3, 'sads', '2023-04-04 01:47:24'),
(117, 2, 3, 'saldks', '2023-04-04 01:47:33'),
(118, 2, 3, 'llllll', '2023-04-04 01:47:42');
