...
<html lang="en">
  <head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="profileLinkstyle.css">
          ...
          <div class="col-md-4">
            <div class="profile-info">
              ...
              <?php
                ...
                <button  type='button' class='btn btn-secondary' id='btnEdit' name='btnEdit' hidden>Unfollow</a>
